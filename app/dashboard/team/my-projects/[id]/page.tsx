...
export default function TeamMyProjectDetailPage() {
              ...
              {loading || !project ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="px-2 py-0.5 text-[10px] md:text-xs rounded-full bg-gray-800 text-gray-300 border border-gray-700">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2 border-t border-gray-700">
                    {project.demoUrl && (
                    ...
                    {project.githubUrl && (
                      <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 underline text-sm">
                        💻 GitHub Repository
                      </a>
                    )}
                  </div>
